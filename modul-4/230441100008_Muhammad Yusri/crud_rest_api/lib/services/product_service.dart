...
class ProductService {
  final String baseUrl = 'https://firestore.googleapis.com/v1/projects/fir-praktikum-8055c/databases/(default)/documents';
  ...
  Future<void> deleteProduct(String id) async {
    try {
      final response = await http.delete(Uri.parse('$baseUrl$collectionPath/$id'));
